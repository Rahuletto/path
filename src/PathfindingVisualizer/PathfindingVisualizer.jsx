...
export default class PathfindingVisualizer extends Component {
  ...
  getInitialGrid = (
    rowCount = this.state.MOBILE_ROW_COUNT,
    colCount = this.state.MOBILE_COLUMN_COUNT,
    wallProbability = 0.3
  ) => {
    const initialGrid = [];
        ...
        if (
          ...
          document.getElementById(`node-${node.row}-${node.col}`).className =
            ...
            this.setState((prevState) => ({
              visitedNodesCount: prevState.visitedNodesCount + 1,
            }));
        }
      }, 10 * i);
    }
  ...
  render() {
    const { grid, mouseIsPressed, visitedNodesCount } = this.state;
    return (
      <div>
        <table
        ...
        <h3 className="visited-nodes-count">Nodes Visited: {visitedNodesCount}</h3>
